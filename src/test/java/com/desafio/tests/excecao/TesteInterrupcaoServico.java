...
//Este cenário simula uma interrupção de serviço após o login.
public class TesteInterrupcaoServico {
    ...
    @Test
    @Description("Teste para simular interrupção de serviço após o login")
    @Epic("Funcionalidades do E-commerce")
    @Feature("Interrupção de Serviço")
    public void testeInterrupcaoServico() throws InterruptedException {
...
Thread.sleep(2000);
        ...
        // Aguardar a finalização da simulação
        Thread.sleep(2000);
    }
